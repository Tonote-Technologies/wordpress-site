...
<section class="section bg-half-100 d-table w-100 bg-gradient">
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-lg-12 text-center">
        <div class="pages-heading my-1">
          <h4 class="ptitle my-3">Privacy Policy</h4>
        </div>
      </div>
    </div>
  </div>
</section>
<section class="ptb-100 mt-4">
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <div class="single-faq">
          ...
          <p>
            Welcome to
            <a href="https://gettonote.com">ToNote Technologies Limited</a>
            (“ToNote”, “We”, “Our” or “Us”) Privacy Policy.
          </p>
          <p>
            We respect your privacy and are committed to protecting your
            Personal Data. This Privacy Policy will inform you as to how we
            collect, use, share and look after your Personal Data when you
            visit our Platform (regardless of where you visit it from) or use
            any of our services and tell you about your privacy rights and how
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>Responsibility for this Policy</h5>
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              Detail Commercial Solicitors is the designated Data Protection
              Officer of the Company who will be responsible for compliance
              with this policy and relevant data protection legislation.
            </li>
            <li class="mb-2 d-flex align-items-start mb-1">
              <span class="ti-check-box mr-2"></span>
            ...
            <li class="list-group-item">
              ...
              Telephone number: (0) 1 2771400-5<br />
            </li>
          </ul>
        </div>
      </div>
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>The Information that We Collect</h5>
          <p>
            ...
            natural person; It can be anything from a name, address, a photo,
            an email address, bank details, posts on social networking
            websites, medical information, and other unique identifier such as
            but not limited to MAC address, IP address, IMEI number, IMSI
            number, SIM, Personal Identifiable Information (PII) and others
            (‘<strong class="text-dark">Personal Data</strong>’).
          </p>
        </div>
      </div>
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>How We Collect, Process, Use and Share Personal Data</h5>
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              We may collect your Personal Data using forms, email and
              physical requests, cookies, JWT, web tokens, or third-party
              applications. You can set your browser to refuse all or some
              browser cookies, or to alert you if we access cookies. If you
              disable or refuse cookies, please note that some parts of this
              Website may become inaccessible or not function properly.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              We use your Personal Data for, verification of your identity;
              human resources management; access to computer systems and
              third-party software; know-your-customer and due diligence
              purposes; recruitment purposes; regulatory compliance;
              performance of a contract with you; compliance with legal
              obligation; marketing; litigation; events planning and hosting;
              in-house security; research, analysis, and other business
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              requests or improve our services provided on our Platform. We
              may also collect information while providing our services to
              you. Our servers automatically record information that your
              browser sends whenever you visit our Platform.
            </li>
          </ul>
        </div>
      </div>
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>Consent and Access Rights</h5>
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              We will obtain your consent prior to collecting or processing
              your Personal Data. Where we intend to use the information for a
              purpose other than the purpose for which it was collected, prior
              to such use, we will request your consent.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              You may withdraw your consent at any time and may request access
              to your Personal Data in our possession. Such withdrawal will
              not affect the lawfulness of the processing of your Personal
              Data prior to the withdrawal of your consent. We can, however,
              deny you access to the information where we determine that your
              request is unreasonable.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              You have the right to request the modification or amendment of
              your Personal Data in our possession.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              In all cases of access or request for modification or amendment
              of Personal Data, we shall request sufficient identification to
              enable us to confirm that you are the owner of the data sought
              to be accessed, modified or amended.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              Where you provide the Personal Data of a third party to us, you
              confirm to us that you have informed the owner of the data about
              the purpose for which the data is required and that you have
              obtained the consent of the owner of the data to provide the
              data to us for the purpose for which it is required and in
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>Personal Data Protection Principles</h5>
          <p>
          ...
          <ul class="list-unstyled support-list">
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              processed lawfully for the purpose for which it was collected
              and not further processed in a manner incompatible with which
              that purpose(s);
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              processed adequately, accurately and without prejudice to the
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              processed in a secure manner and protected against unauthorised
              or unlawful access or processing or accidental loss, destruction
              or damage.
            </li>
          </ul>
        </div>
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          ...
          <p>
            We have put in place and will maintain appropriate security
            measures to prevent your Personal Data from being used, accessed,
            altered or disclosed in unauthorised way.
          </p>
        </div>
      </div>
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>Access by Third Parties</h5>
          <p>
          ...
          <ul class="list-unstyled support-list">
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              when with our parent company(ies), subsidiary or affiliates;
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              processing Personal Data on our behalf or other legitimate
              business purposes. We would require such parties to process such
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              disclosure of such information is reasonably necessary to (i)
              ...
              thereof, (iii) detect, prevent, or otherwise address fraud,
              security or technical issues, or (iv) protect against imminent
              harm to our rights, property or safety as required or permitted
              by law.
            </li>
          </ul>
        </div>
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          ...
          <p>
            We may transfer Personal Data outside Nigeria in the following
            circumstances:
          </p>
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              between you and ToNote or the implementation of pre-contractual
              measures taken at your request;
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              the transfer is necessary for the conclusion or performance of a
              contract concluded in your interest between the Company and
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              interests; or of other persons, where you are physically or
              legally incapable of giving consent.
            </li>
          </ul>
          <p>
            Upon the transfer of information outside Nigeria, some principles
            of data protection may be violated in the receiving country. By
            consenting to the processing of your Personal Data, you consent to
            the transfer of your Personal Data outside Nigeria.
          </p>
        </div>
      </div>
      <div class="col-12 mb-4">
        <div class="single-faq">
          ...
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              respect to our relationship with you. Where information is kept
              for a longer period, such as in back up storage, or archives,
              such information would be safeguarded in accordance with this
              Privacy Policy.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              ...
              regulatory, reporting or other requirements.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              Where any information retained is stored in an encrypted format,
              considerations must be taken for secure storage of the
              encryption keys. Encryption keys must be retained as long as the
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          <h5>Violations</h5>
          <p>
            We will take swift action to remedy any suspected breaches of
            Personal Data.
          </p>
          <p>
          ...
          <ul class="list-unstyled support-list">
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              any act of God (including but not limited to fires, explosions,
              earthquakes, floods, epidemics, or pandemics) which compromises
              our data protection measures;
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              war, hostilities (whether war be declared or not), invasion, act
              of foreign enemies, requisition, or embargo, rebellion,
              revolution, insurrection, or military or usurped power, or civil
              war which compromises our data protection measures;
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
          ...
          <p>
            If you know or suspect that a breach of Personal Data has
            occurred, or a violation of this Privacy Policy has occurred, you
            should immediately contact the Data Protection Officer at the
            contact information provided above.
          </p>
          <p>
            Violations of this Privacy Policy by employees may result in
            disciplinary action.
          </p>
        </div>
      </div>
        ...
        <div class="single-faq">
          ...
          <ul class="list-unstyled support-list">
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              on a legitimate interest (or those of a third party) and there
              is something about your particular situation which makes you
              want to object to processing on this ground as you feel it
            ...
            <li class="mb-2 d-flex align-items-start mb-4">
              ...
              <p>
                ...
                legal claims.
                <br />
                iv. You have objected to our use of your Personal Data but we
                need to verify whether we have overriding legitimate grounds
                to use it.
              </p>
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
          ...
          <p>
            If you wish to exercise any of the rights set out above, contact
            the Data Protection Officer at the contact information provided
            above.
          </p>
          <p>You will not have to pay a fee to:</p>
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
          ...
          <ul class="list-unstyled support-list">
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              any of your requests is clearly unfounded, repetitive, or
              excessive. Alternatively, we could refuse to comply with your
              request in these circumstances if any criminal or illegal
              activity is suspected.
            </li>
            <li class="mb-2 d-flex align-items-start mb-4">
              <span class="ti-check-box mr-2"></span>
              you request to change your Personal Data in our possession more
              than three (3) times within a 12-month period.
            </li>
          </ul>
          <p>
      ...
      <div class="col-12 mb-4">
        <div class="single-faq">
          ...
          <p>
            ...
            Policy, or know or suspect that a breach of your Personal Data or
            a violation of this Privacy Policy has occurred, or if you have
          ...
          <p class="list-group-item">
            ...
            ask@gettonote.com<br />
            <strong class="text-dark">Office Address:</strong> 1625b Saka Jojo
            Street, Victoria Island, Lagos<br />
            <strong class="text-dark">Telephone:</strong> +234 814 650 7035
          </p>
        </div>
      </div>
    </div>
